...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />    
        <div class="sponimg">    
            ...
            <asp:GridView ID="grdSponsor" runat="server" DataKeyNames="SponsorId" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                <Columns>
                    <asp:BoundField DataField="SponsorId" HeaderText="SponsorId" InsertVisible="False" ReadOnly="True" SortExpression="SponsorId" />
                    <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
                    <asp:BoundField DataField="ShortDescription" HeaderText="ShortDescription" SortExpression="ShortDescription" />
                    <asp:ImageField DataImageUrlField="Logo" DataImageUrlFormatString="img/Sponsors/{0}">
                    </asp:ImageField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:snowdriftersdbConnectionString %>" 
        ...
        UpdateCommand="UPDATE [Sponsors] SET [Name] = @Name, [ShortDescription] = @ShortDescription, [Logo] = @Logo, [Address] = @Address, [Phone] = @Phone, [Email] = @Email, [Website] = @Website WHERE [SponsorId] = @original_SponsorId">
        <DeleteParameters>
