<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GalleryEditor.aspx.cs" Inherits="SnoDrifters.GalleryEditor" %>
            ...
            <div id="editAlbum">
                <asp:GridView ID="grdAlbums" runat="server" AutoGenerateDeleteButton="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Album_Id" HeaderText="Album_Id" InsertVisible="False" 
                            ReadOnly="True" SortExpression="Album_Id" />
                        
                        <asp:BoundField DataField="Album_Name" HeaderText="Album_Name" SortExpression="Album_Name" />
                        <asp:BoundField DataField="Album_Sequence" HeaderText="Album_Sequence" SortExpression="Album_Sequence" />
                        <asp:BoundField DataField="Album_Description" HeaderText="Album_Description" SortExpression="Album_Description" />
                    </Columns>
                </asp:GridView>
